...
__Определение__.  Пара (<a href="https://www.codecogs.com/eqnedit.php?latex=x^2" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x^2" title="x^2" /></a>, <img src="http://www.sciweavers.org/tex2img.php?eq=y%5E2&bc=White&fc=Black&im=jpg&fs=12&ff=modern&edit=0" align="center" border="0" alt="y^2" width="18" height="19" />) *∈ X × Y* называется *седловой* точкой функции *F(x, y)* на *X × Y*, если
